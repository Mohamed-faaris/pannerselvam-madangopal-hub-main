  ...
  const milestones = [
    {
      ...
      icon: <Target style={{ color: "hsl(38, 92%, 50%)" }} size={24} />,
    },
    {
      year: "2020",
      ...
      icon: <Users style={{ color: "hsl(38, 92%, 50%)" }} size={24} />,
    },
    {
      year: "2018",
      ...
      icon: <Award style={{ color: "hsl(38, 92%, 50%)" }} size={24} />,
    },
    {
      year: "2015",
      ...
      icon: <MapPin style={{ color: "hsl(38, 92%, 50%)" }} size={24} />,
    },
  ];
    ...
    <Layout>
      ...
      <section className="about-hero">
        <div className="about-container">
          <h1 className="about-title">About Pannerselvam Madanagopal</h1>
      ...
      {/* Biography */}
      <section className="about-section about-bg-primary">
        <div className="about-container">
          <div className="bio-grid">
            <div className="bio-content">
              <h2 className="bio-title">Leadership Journey</h2>
            ...
            <Card>
              <CardContent>
                ...
                <div className="expertise-grid">
                  {expertise.map((skill) => (
                    <div key={skill} className="expertise-badge">
                      {skill}
                    </div>
                  ))}
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              {milestones.map((milestone, index) => (
                <Card
                  key={index}
                  className="shadow-soft border-card-border hover:shadow-medium transition-all"
                >
            ...
            <Card className="shadow-medium border-card-border">
              <CardContent className="p-12">
                <blockquote className="text-2xl font-light text-center leading-relaxed text-muted-foreground mb-8">
                  ...
                  technology can fulfill. My mission is to bridge the gap
                  between innovation and impact, ensuring that every
                  technological advancement serves the greater good of society."
                </blockquote>
