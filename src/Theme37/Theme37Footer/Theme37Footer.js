        ...
        <div style={footerStyles.grid}>
          ...
          <div style={footerStyles.section}>
            ...
            <p style={footerStyles.description}>
              CEO of Meity, Technology Leader, and Visionary Entrepreneur
          ...
          <div style={footerStyles.section}>
            ...
            <p style={footerStyles.newsletterText}>
              Subscribe to receive insights and updates on technology
              leadership.
            </p>
            <div style={footerStyles.newsletterForm}>
              ...
              />
              <button style={footerStyles.subscribeButton}>Subscribe</button>
            </div>
          </div>
        </div>
        ...
        <div style={footerStyles.bottomSection}>
          <div style={footerStyles.bottomContent}>
            ...
            <div style={footerStyles.bottomLinks}>
              <Link to="/privacy" style={footerStyles.bottomLink}>
                Privacy Policy
              </Link>
              <Link to="/terms" style={footerStyles.bottomLink}>
                Terms of Service
              </Link>
            </div>
          </div>
