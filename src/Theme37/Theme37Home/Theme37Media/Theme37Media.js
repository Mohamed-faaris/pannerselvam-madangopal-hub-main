          ...
          <div style={mediaStyles.featuredCard}>
            <div style={mediaStyles.featuredGrid}>
              ...
              <div style={mediaStyles.featuredContent}>
                <h3 style={mediaStyles.featuredTitle}>
                  {featuredVideo.title}
                </h3>
          ...
          <div style={mediaStyles.videoGrid}>
            {videos.map((video) => (
              <div
                ...
                onMouseEnter={(e) => {
                  Object.assign(e.currentTarget.style, mediaStyles.videoCardHover);
                }}
                onMouseLeave={(e) => {
              ...
              >
                ...
                <div style={mediaStyles.videoContent}>
                  <h3 style={mediaStyles.videoTitle}>
                    {video.title}
                  </h3>
              ...
              <div key={article.id} style={mediaStyles.pressCard}>
                <div style={mediaStyles.pressHeader}>
                  <div style={mediaStyles.pressMeta}>
                    ...
                    <span style={mediaStyles.publication}>{article.publication}</span>
                    <span style={mediaStyles.articleType}>{article.type}</span>
                  </div>
                </div>
                <h3 style={mediaStyles.pressTitle}>
                  {article.title}
                </h3>
                <p style={mediaStyles.pressExcerpt}>
                  {article.excerpt}
                </p>
          ...
          <div style={mediaStyles.podcastGrid}>
            {podcasts.map((podcast) => (
              <div key={podcast.id} style={mediaStyles.podcastCard}>
                ...
                <div style={mediaStyles.podcastDate}>
                  {podcast.date}
                </div>
              </div>
            ))}
