...
const Theme37Gallery = () => {
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      category: "Awards",
      description:
        "Recognition for outstanding contribution to technology policy",
      image:
        "https://images.unsplash.com/photo-1551818255-e6e10975cd84?w=800&h=600&fit=crop",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      category: "Awards",
      description:
        "International recognition for digital transformation leadership",
      image:
        "https://images.unsplash.com/photo-1551818255-e6e10975cd84?w=800&h=600&fit=crop",
    },
    {
    ...
    <section style={galleryStyles.section}>
      <div style={galleryStyles.container}>
        ...
        <div style={galleryStyles.hero}>
          <h1 style={galleryStyles.heroTitle}>Gallery</h1>
          <p style={galleryStyles.heroSubtitle}>
            A visual journey through key moments, achievements, and events that
            shape the landscape of technology leadership and innovation.
          </p>
        </div>
          ...
          {filters.map((filter) => (
            <button
              ...
              style={{
                ...
                ...(activeFilter === filter
                  ? galleryStyles.filterButtonActive
                  : {}),
              }}
            >
              {filter}
          ...
          {filteredItems.map((item) => (
            ...
            >
              <div style={galleryStyles.cardImageContainer}>
                ...
                />
                <div style={galleryStyles.categoryBadge}>{item.category}</div>
              </div>
              <div style={galleryStyles.cardContent}>
                <h3
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.color =
                      galleryStyles.cardTitleHover.color;
                  }}
                  onMouseLeave={(e) => {
                ...
                <p style={galleryStyles.cardDescription}>{item.description}</p>
              </div>
            </div>
          ))}
        </div>
