          ...
          <div style={blogStyles.featuredCard}>
            <div style={blogStyles.featuredGrid}>
              ...
              <div style={blogStyles.featuredContent}>
                <h3 style={blogStyles.featuredTitle}>
                  {featuredPost.title}
                </h3>
                <p style={blogStyles.featuredExcerpt}>
            ...
            {categories.map((category) => (
              <button
                ...
                style={{
                  ...
                  ...(activeCategory === category ? blogStyles.categoryButtonActive : {})
                }}
              >
                {category}
              </button>
          ...
          <div style={blogStyles.blogGrid}>
            {filteredPosts.map((post) => (
              <div
                ...
                onMouseEnter={(e) => {
                  Object.assign(e.currentTarget.style, blogStyles.blogCardHover);
                }}
                onMouseLeave={(e) => {
              ...
              >
                <div style={blogStyles.blogImageContainer}>
                  <img
                    ...
                    onMouseEnter={(e) => {
                      Object.assign(e.currentTarget.style, blogStyles.blogImageHover);
                    }}
                    onMouseLeave={(e) => {
                      Object.assign(e.currentTarget.style, blogStyles.blogImage);
                    }}
                  />
                ...
                <div style={blogStyles.blogContent}>
                  <h3
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.color = blogStyles.blogTitleHover.color;
                    }}
                    onMouseLeave={(e) => {
                  ...
                  <p style={blogStyles.blogExcerpt}>
                    {post.excerpt}
                  </p>
        ...
        <div style={blogStyles.newsletterSection}>
          <div style={blogStyles.newsletterContent}>
            ...
            <div style={blogStyles.newsletterForm}>
              ...
              />
              <button style={blogStyles.subscribeButton}>
                Subscribe
              </button>
            </div>
          </div>
